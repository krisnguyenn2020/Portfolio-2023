...
const HackerNews = () => {
   ...
   return (
      <div className="p-5 bg-white shadow-md my-5 mx-auto rounded-lg w-2/4">
         <div className="flex flex-between gap-5 my-5">
            <input
               type="text"
               className="border border-gray-200 block w-full rounded text-black p-5 mb-5 focus:border-blue-400 transition-all"
               placeholder="Typing your keyword..."
               defaultValue={query}
               onChange={handleUpdateQuery}
            />
            <button type="submit" className="bg-blue-400 rounded-md my-5 px-5">Fetch</button>
         </div>
         {loading && (
